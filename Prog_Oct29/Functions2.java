...
public class Functions2 {
	...
	public static void main(String[] args) 
	{
		...
		while(!D.equals("2D") || !D.equals("3D"))
		{
			...
			{
				String E = "";
				while(!E.equals("square") || !E.equals("circle") || !E.equals("triangle"))
				{
					System.out.println("square, circle or triangle?");
					E = scan.nextLine();
					E = E.toLowerCase();
					function1(E);
					if(E.equals("square") || E.equals("circle") || E.equals("triangle"))
						break;
				}
				break;
			}
			else if(D.equals("3D"))
			{
				...
				while(!E.equals("cylinder") || !E.equals("rectprism") || !E.equals("pyramid"))
				{
					...
					E = E.toLowerCase();
					function2(E);
					if(E.equals("cylinder") || E.equals("rectprism") || E.equals("pyramid"))
						break;
				}
				break;
			}
	...
	public static void function1(String E)
	{		
		if(E.equals("square"))
		{
	...
	public static void function2(String E)
	{	
